  ...
  try {
    ...
    const response = await fetch(googleFormURL, {
      ...
      headers: {
        ...
        "Referer": "https://docs.google.com/forms/d/e/1FAIpQLScNJhGtcfiscV4-r553336JR8XbZgzLCnYHYuTquh0pUUEt-Q/viewform", // Refers to the form page
        "Origin": "https://docs.google.com", // The domain from which the form is hosted
      }
    });
